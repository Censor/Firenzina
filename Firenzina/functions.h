...
void InitSlab(int);
void CreateMem(void **, int, uint64, int *, boolean *, char *);
void FreeMem(void *, int *, boolean *);
uint64 GetRand();
...
boolean TripleValue(typePos *, int *, boolean, boolean);
void InitTotalBase();
...
boolean IvanSplit(typePos *, typeNext *, int, int, int, int, int *);
